...
public class EmployeController {
    ...
    public Optional<Employe> getEmploye(@PathVariable Long id){
        ...
        return (Optional<Employe>) employe;
    }
    ...
    public Employe updateEmploye(Employe employe){
        Employe emp = employeService.findById(employe.getId());
        emp.setFirst_name(employe.getFirst_name());
        emp.setLast_name(employe.getLast_name());
        emp.setMail(employe.getMail());
